...
function proximaImgIframeImg(){
    ...
    if (cardapioClasseNome == cardapioNomes_01_[1] && cardapioClasseNumero < parseFloat(cardapioNumero_01_[1])){
    ...
    else if (cardapioClasseNome == cardapioNomes_01_[2] && cardapioClasseNumero < parseFloat(cardapioNumero_01_[2])){
        document.getElementById("linkDescricaoImagemGrande").href = "../Img/Main/" + cardapioClasse.slice(cardapioClasse,-4) + "/" +  (("0000" + (parseFloat(cardapioClasseNumero) + 1)).slice(-4)) + ".jpg";
        document.getElementById("descricaoImagemGrande").src = "../Img/Main/" + cardapioClasse.slice(cardapioClasse,-4) + "/" +  (("0000" + (parseFloat(cardapioClasseNumero) + 1)).slice(-4)) + ".jpg";
        document.getElementById("descricaoImagemGrande").className = "descricaoImagemGrande " + cardapioClasse.slice(cardapioClasse,-4) + (("0000" + (parseFloat(cardapioClasseNumero) + 1)).slice(-4));
        document.getElementById('conteudoImagempequena conteudoImagempequena' +  (("0000" + (parseFloat(cardapioClasseNumero))).slice(-4))).style.background = "#00000000";
    ...
    else if (cardapioClasseNome == cardapioNomes_02_[1] && cardapioClasseNumero < parseFloat(cardapioNumero_02_[1])){
        document.getElementById("linkDescricaoImagemGrande").href = "../Img/Main/" + cardapioClasse.slice(cardapioClasse,-4) + "/" +  (("0000" + (parseFloat(cardapioClasseNumero) + 1)).slice(-4)) + ".jpg";
        document.getElementById("descricaoImagemGrande").src = "../Img/Main/" + cardapioClasse.slice(cardapioClasse,-4) + "/" +  (("0000" + (parseFloat(cardapioClasseNumero) + 1)).slice(-4)) + ".jpg";
        document.getElementById("descricaoImagemGrande").className = "descricaoImagemGrande " + cardapioClasse.slice(cardapioClasse,-4) + (("0000" + (parseFloat(cardapioClasseNumero) + 1)).slice(-4));
        document.getElementById('conteudoImagempequena conteudoImagempequena' +  (("0000" + (parseFloat(cardapioClasseNumero))).slice(-4))).style.background = "#00000000";
    ...
    else if (cardapioClasseNome == cardapioNomes_02_[2] && cardapioClasseNumero < parseFloat(cardapioNumero_02_[2])){
        document.getElementById("linkDescricaoImagemGrande").href = "../Img/Main/" + cardapioClasse.slice(cardapioClasse,-4) + "/" +  (("0000" + (parseFloat(cardapioClasseNumero) + 1)).slice(-4)) + ".jpg";
        document.getElementById("descricaoImagemGrande").src = "../Img/Main/" + cardapioClasse.slice(cardapioClasse,-4) + "/" +  (("0000" + (parseFloat(cardapioClasseNumero) + 1)).slice(-4)) + ".jpg";
        document.getElementById("descricaoImagemGrande").className = "descricaoImagemGrande " + cardapioClasse.slice(cardapioClasse,-4) + (("0000" + (parseFloat(cardapioClasseNumero) + 1)).slice(-4));
        document.getElementById('conteudoImagempequena conteudoImagempequena' +  (("0000" + (parseFloat(cardapioClasseNumero))).slice(-4))).style.background = "#00000000";
    ...
    else if (cardapioClasseNome == cardapioNomes_02_[3] && cardapioClasseNumero < parseFloat(cardapioNumero_02_[3])){
        document.getElementById("linkDescricaoImagemGrande").href = "../Img/Main/" + cardapioClasse.slice(cardapioClasse,-4) + "/" +  (("0000" + (parseFloat(cardapioClasseNumero) + 1)).slice(-4)) + ".jpg";
        document.getElementById("descricaoImagemGrande").src = "../Img/Main/" + cardapioClasse.slice(cardapioClasse,-4) + "/" +  (("0000" + (parseFloat(cardapioClasseNumero) + 1)).slice(-4)) + ".jpg";
        document.getElementById("descricaoImagemGrande").className = "descricaoImagemGrande " + cardapioClasse.slice(cardapioClasse,-4) + (("0000" + (parseFloat(cardapioClasseNumero) + 1)).slice(-4));
        document.getElementById('conteudoImagempequena conteudoImagempequena' +  (("0000" + (parseFloat(cardapioClasseNumero))).slice(-4))).style.background = "#00000000";
        ...
        document.getElementById("linkDescricaoImagemGrande").href = "../Img/Main/" + cardapioClasse.slice(cardapioClasse,-4) + "/0001.jpg";
